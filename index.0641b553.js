...
(function() {
    ...
    const xText = "X";
    const oText = "O";
    const xSoundPath = new URL(require("386a6a1d6115ede0"));
    const oSoundPath = new URL(require("7840b5804821162a"));
    const applauseSoundPath = new URL(require("3de9d063c90b0a1a"));
...
},{"386a6a1d6115ede0":"cJjQa","7840b5804821162a":"2gdpY","3de9d063c90b0a1a":"ddbGs"}],"cJjQa":[function(require,module,exports,__globalThis) {
module.exports = require("95fce3a621d45d21").getBundleURL('lPpKD') + "player-x-click.edd0184a.mp3" + "?" + Date.now();

},{"95fce3a621d45d21":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"2gdpY":[function(require,module,exports,__globalThis) {
module.exports = require("77e56426a08a5194").getBundleURL('lPpKD') + "player-o-click.228dc4c8.mp3" + "?" + Date.now();

},{"77e56426a08a5194":"lgJ39"}],"ddbGs":[function(require,module,exports,__globalThis) {
module.exports = require("426342600d874d67").getBundleURL('lPpKD') + "applause-cheer.7b7d4b3e.mp3" + "?" + Date.now();

},{"426342600d874d67":"lgJ39"}]},["cLDdI","bNKaB"], "bNKaB", "parcelRequire94c2")
